        ...
        <div className={cn("relative", className)} ref={dropdownRef}>
            ...
            >
                <div className="flex items-center gap-3 overflow-hidden">
                    ...
                    />
                    <span className="text-sm font-bold truncate">{selectedCountry.code}</span>
                </div>
                <ChevronDown
                    size={16}
                    className={cn("text-muted-foreground transition-transform duration-300 flex-shrink-0", isOpen && "rotate-180")}
                />
            </div>
